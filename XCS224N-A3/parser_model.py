...
class ParserModel(nn.Module):
    ...
    def forward(self, t):
        ...
        embed_to_hidden = self.embed_to_hidden(embeddings)
        hidden_units = nn.ReLU()(embed_to_hidden)
        hidden_units_dropout = self.dropout(hidden_units)
        logits = self.hidden_to_logits(hidden_units_dropout)
        ### END YOUR CODE
        return logits
